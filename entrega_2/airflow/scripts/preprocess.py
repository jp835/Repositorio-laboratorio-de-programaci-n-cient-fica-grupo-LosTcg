...
# --- 1. CLASES DE TRANSFORMACIÓN PERSONALIZADAS ---
...
# ... (las otras clases se mantienen igual que en tu código original)
# ReduceCorrelation, ColumnTypeSelector, DropColumns, IQRTransformer
...
def get_engineering_pipeline():
    ...
    cols_to_drop = [
        'product_id', 
        'customer_id', 
        'compró',      # Target (Leakage)
        'items',       # Items comprados (Leakage)
...
# --- 3. PREPROCESSOR (Transformación Final) ---
...
def get_preprocessor(numeric_features, categorical_features):
    ...
    preprocessor = ColumnTransformer(
        ...
        remainder="drop",
        verbose_feature_names_out=True # Queremos los nombres de las columnas OHE
    )
    return preprocessor